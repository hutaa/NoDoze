...
export default function HomeScreen() {
    ...
    if (cameraRef.current && isCameraReady) {
      try {
        ...
        if (photo?.base64) {
          ...
          recordFrame(data.isDrowsy); // track frame in hook
  ...
  const alertnessScore = totalFrames.current === 0 ? null :
    Math.round(((totalFrames.current - drowsyFrames.current) / totalFrames.current) * 100);
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>
                {alertnessScore === null ? '—' : `${alertnessScore}%`}
              </Text>
